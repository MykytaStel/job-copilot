...
export function useProfilePage() {
  ...
  return {
    ...
    resumes: queries.resumesQuery.data ?? [],
    activeJobsCount: queries.activeJobsQuery.data?.summary.activeJobs ?? 0,
    ...
    addExperience: draftForm.addExperience,
    updateExperience: draftForm.updateExperience,
    removeExperience: draftForm.removeExperience,
