...
export function GlobalSearch() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-50 bg-black/55 p-4 pt-20 backdrop-blur-sm"
          onClick={close}
        >
          <div
          ...
          >
            ...
            <div className="max-h-[70vh] overflow-y-auto p-3">
              ...
              {debouncedQuery.length > 0 && !searchQuery.isLoading && !searchQuery.isError && !hasResults && (
                ...
                <section className="space-y-2 pt-3">
                  ...
                  {searchQuery.data?.applications.map((application) => (
                    <button
                      key={application.id}
                      type="button"
                      onClick={() => navigateTo(`/applications/${application.id}`)}
