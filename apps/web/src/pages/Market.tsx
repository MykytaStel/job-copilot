        ...
        {overviewQuery.isPending ? (
          ...
          <>
            <StatCard
              ...
              value={overviewQuery.data ? formatCount(overviewQuery.data.newJobsThisWeek) : '—'}
              description={
                overviewQuery.data
            ...
            <StatCard
              ...
              value={
                overviewQuery.data ? formatCount(overviewQuery.data.activeCompaniesCount) : '—'
              }
            ...
            <StatCard
              title="Remote share"
              value={overviewQuery.data ? formatPercent(overviewQuery.data.remotePercentage) : '—'}
