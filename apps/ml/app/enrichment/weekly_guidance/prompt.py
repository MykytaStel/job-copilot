...
def build_weekly_guidance_prompt(context: WeeklyGuidanceRequest) -> WeeklyGuidancePrompt:
    ...
    return WeeklyGuidancePrompt(
        system_instructions=(
            ...
            "If llm_context.top_model_signals is present, these are the behavioral features with the most weight in the user's personalized ranking model — reference them when explaining what drives their job matches. "
